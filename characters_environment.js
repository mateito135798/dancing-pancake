...
function game(){
  ...
  console.log("evox = " + evox +" ,evoy =  "+ evoy);
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("DA CLIC AL BOTON ¨STERT¨PARA JUGAR ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
...
function changeGameStatus(character){
 if(evox !="" && gameConfig.status==="start" && GameStatus=="start") { 
...
function jumping(character){
	if( (evoy < 200   &&character.live) || (touchIsDown&&character.live) ){
